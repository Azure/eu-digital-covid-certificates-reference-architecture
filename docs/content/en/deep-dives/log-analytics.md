...
> __Calls to Action__
>
>Learn more about **Azure Log Analytics** and get the most up-to-date information at the [Microsoft Docs](https://docs.microsoft.com/en-us/azure/azure-monitor/logs/log-analytics-tutorial).
>
